                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @VVV5P\
                                  \n\n--------بـدء تتبـع سجـل تيبثـون surs alzaeim--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع تيبثـون surs alzaeim--------"
                        ...
                        text = (
                            "**✘ تقـريـر إشعـار تيبثـون surs alzaeim ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار تيبثـون surs alzaeim ✘**\n\n "
                        link = "[الزعيم](https://t.me/T_5_G)"
