...
ZelzalDV_cmd = (
    "𓆩 [اوامــر المطـور المســاعد الزعيم](t.me/rr_r_v) 𓆪\n\n"
    ...
    "\n𓆩 [مطـور السـورس الزعيم](t.me/rr_r_v) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت الـزعيــم alzaeim انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن alzaeim :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت الـزعيــم alzaeim انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
