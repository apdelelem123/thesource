...
ZelzalDV_cmd = (
    "𓆩 [𝘀𝘂𝗿𝘀 𝗮𝗹𝘇𝗮𝗲𝗶𝗺 - اوامــر المطـور المســاعد](t.me/Tepthon) 𓆪\n\n"
    ...
    "\n𓆩 [ الزعيم - مطـور السـورس](t.me/T_5_G) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت تيبثـون 𝗮𝗹𝘇𝗮𝗲𝗶𝗺 انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝗮𝗹𝘇𝗮𝗲𝗶𝗺 :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت تيبثـون 𝗮𝗹𝘇𝗮𝗲𝗶𝗺 انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
