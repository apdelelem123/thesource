...
ZelzalChecler_cmd = (
    ...
    "𓆩 [surs alzaeim - أوامـر الصيد والتشيكـر](t.me/VVV5P) 𓆪\n\n"
...
"𓆩 [surs alzaeim - أنـواع اليـوزرات](t.me/VVV5P) 𓆪\n\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    title="⎉ صيـد ريبثون surs alzaeim ⎉",
    ...
    try:
        ...
        ch = await zedub(
            ...
            functions.channels.CreateChannelRequest(
                ...
                title="⎉ تثبيت ريبثون surs alzaeim ⎉",

                about="تم تثبيت اليـوزر بواسطـة سـورس ريبثون - @VVV5P ",
