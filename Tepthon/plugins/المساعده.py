        ...
        await event.edit(
            ...
            buttons=[
                ...
                [
                    ...
                    Button.inline(" الزعيم عبود", data="zedvr"),
                ],
                [
...
async def _(event):
    await event.edit(
        """[ᯓ سورس الزعيم  - اوامــر البـــوت 🦾🤖](t.me/rr_r_v) .
**- الامـر :**
**⪼** `.النظام`
...
async def _(event):
    await event.edit(
        """[ᯓ  𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر البـــوت 🦾🤖](t.me/rr_r_v) .
**- الامـر :**
**⪼** `.السرعه`
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ  سورس الزعيم - اوامــر المجمــوعــه 🛗](t.me/TepThon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ  سورس الزعيم - اوامــر المجمــوعــه¹](t.me/rr_r_v) .
**- الامـر :**
**⪼** `.تحذير`
**⪼** `.التحذيرات`
**⪼** `.حذف التحذيرات`
...
async def _(event):
    await event.edit(
        "[ᯓ  الـزعيــم - اوامــر المجمــوعــه¹ 🛗](t.me/rr_r_v) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه¹ :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ الـزعيــم 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المجمــوعــه¹](t.me/rr_r_v) .
**- الامـر :**
**⪼** `.قفل الميديا`
**⪼** `.فتح الميديا`
...
async def _(event):
    await event.edit(
        """[ᯓ الـزعيــم 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/rr_r_v) .
**- الامـر :**
**⪼** `.حذف رسائلي`
**⪼** `.مسح`
...
async def _(event):
    await event.edit(
        """[ᯓ الـزعيــم 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر مكـافح التكــرار 🛡](t.me/rr_r_v) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ الـزعيــم 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المنــع 🚫](t.me/rr_r_v) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ الـزعيــم 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاضـافه والتفليـش 👾](t.me/rr_r_v) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ الـزعيــم 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الفــارات 🧬](t.me/rr_r_v) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        "[ᯓ الـزعيــم 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات الوقتــي 🕰](t.me/rr_r_v) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ الـزعيــم 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/rr_r_v) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ الـزعيــم 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات حمايـة الخــاص 🛄](t.me/rr_r_v) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ الـزعيــم 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات الفحـص 🏮](t.me/rr_r_v) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ  سورس الزعيم - اوامــر البحـث والتحميــل 🛰](t.me/rr_r_v) .
**- الامـر :**
**⪼** `.ساوند`
...
async def _(event):
    await event.edit(
        """[ᯓ الـزعيــم 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الصيـد & التشيكـر ❇️](t.me/rr_r_v) .
...
async def zed_help(event):
    await event.edit(
        "[ᯓ الـزعيــم 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميـع النقـاط 💡](t.me/rr_r_v) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ الـزعيــم 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميــع النقــاط 🛂](t.me/rr_r_v) .
**- الامـر :**
**⪼** `.المليار`
