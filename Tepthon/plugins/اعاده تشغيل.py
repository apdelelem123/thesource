...
async def _(event):
    ...
    sandy = await edit_or_reply(
        ...
        f"**•⎆┊يتـم الان اعـادة تشغيـل بـوت ريبثون قـد يستغـرق الامـر 1-2 دقيقـة ▬▭ ...**",
    )
    try:
...
@zedub.zed_cmd(
    ...
    info={
        ...
        "الوصـف": "لـ إطفـاء الداينـو الخاص بتنصيبك بهيروكـو .. لا تستطيع اعادة التشغيل مرة اخرى عبر حسابك عليك الذهاب لحساب هيروكو واتباع الشرح التالي https://t.me/VVV5P",
...
async def _(event):
    ...
    await edit_or_reply(event, "**✾╎جــارِ إيقـاف تشغيـل بـوت ريبثون الآن 📟 ...**\n\n**✾╎شغِّـلنـي يـدويًـا لاحقًــا**\n**✾╎باتبـاع الشـرح** https://t.me/VVV5P")
