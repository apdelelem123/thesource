...
zel_dev = (6700336976, 2348181015, 95801588376, 1239602580)
...
async def startmute(event):
    ...
    if event.is_private:
        ...
        if event.chat_id == 6700336976 or event.chat_id == 1895219306 or event.chat_id == 2095357462:
        ...
        if user.id == 6700336976 or user.id == 1895219306 or user.id == 2095357462:
